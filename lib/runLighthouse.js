// use this script to run lighthouse from a node prompt
// "> node runLighthouse.js" instead of "lighthouse"
...
require('../lib/lighthouse.js')(options, function(err, lighthouse) {
  //what to do here?
  return lighthouse
})
